...
const typename iit::Fancy::dyn::tpl::InverseDynamics<TRAIT>::ExtForces
iit::Fancy::dyn::tpl::InverseDynamics<TRAIT>::zeroExtForces(Force::Zero());

template <typename TRAIT>
iit::Fancy::dyn::tpl::InverseDynamics<TRAIT>::InverseDynamics(IProperties& inertia, MTransforms& transforms) :
    ...
    std::cout << "Robot Fancy, InverseDynamics<TRAIT>::InverseDynamics()" << std::endl;
...
template <typename TRAIT>
void iit::Fancy::dyn::tpl::InverseDynamics<TRAIT>::id(
    JointState& jForces,
...
template <typename TRAIT>
void iit::Fancy::dyn::tpl::InverseDynamics<TRAIT>::G_terms(JointState& jForces)
{
    // Link 'link1'
    link1_a = (xm->fr_link1_X_fr_FancyBase).col(iit::rbd::LZ) * Scalar(iit::rbd::g);
...
template <typename TRAIT>
void iit::Fancy::dyn::tpl::InverseDynamics<TRAIT>::C_terms(JointState& jForces, const JointState& qd)
{
    // Link 'link1'
...
template <typename TRAIT>
void iit::Fancy::dyn::tpl::InverseDynamics<TRAIT>::firstPass(const JointState& qd, const JointState& qdd, const ExtForces& fext)
{
...
template <typename TRAIT>
void iit::Fancy::dyn::tpl::InverseDynamics<TRAIT>::secondPass(JointState& jForces)
{
    // Link 'link5'
