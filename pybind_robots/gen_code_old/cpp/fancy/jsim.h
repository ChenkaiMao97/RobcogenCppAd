#ifndef IIT_FANCY_JSIM_H_
#define IIT_FANCY_JSIM_H_
...
class JSIM : public iit::rbd::StateDependentMatrix<iit::Fancy::tpl::JointState<typename TRAIT::Scalar>, 5, 5, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::Fancy::tpl::JointState<typename TRAIT::Scalar>, 5, 5, JSIM<TRAIT>> Base;
    public:
        typedef typename TRAIT::Scalar Scalar;
        typedef typename iit::Fancy::tpl::JointState<Scalar> JointState;
        typedef iit::rbd::Core<Scalar> CoreS;
        typedef typename Base::Index Index;
        typedef typename iit::rbd::PlainMatrix<Scalar, 5, 5> MatrixType;
        typedef InertiaProperties<TRAIT> IProperties;
        typedef iit::Fancy::tpl::ForceTransforms<TRAIT> FTransforms;
