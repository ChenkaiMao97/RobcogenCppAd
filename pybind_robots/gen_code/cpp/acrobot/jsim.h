...
class JSIM : public iit::rbd::StateDependentMatrix<iit::Acrobot::tpl::JointState<typename TRAIT::Scalar>, 2, 2, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::Acrobot::tpl::JointState<typename TRAIT::Scalar>, 2, 2, JSIM<TRAIT>> Base;
    public:
        typedef typename TRAIT::Scalar Scalar;
        typedef typename iit::Acrobot::tpl::JointState<Scalar> JointState;
        typedef iit::rbd::Core<Scalar> CoreS;
        typedef typename Base::Index Index;
        typedef typename iit::rbd::PlainMatrix<Scalar, 2, 2> MatrixType;
        typedef InertiaProperties<TRAIT> IProperties;
        typedef iit::Acrobot::tpl::ForceTransforms<TRAIT> FTransforms;
