...
#include "../gen_code/cpp/robotname/declarations.h"
#include "../gen_code/cpp/robotname/inertia_properties.h"
#include "../gen_code/cpp/robotname/transforms.h"
#include "../gen_code/cpp/robotname/inverse_dynamics.h"
#include "../gen_code/cpp/robotname/forward_dynamics.h"
...
namespace robot_utils {
    ...
    typedef Robotname::tpl::JointState<Scalar> AD_JointState;

    static constexpr int q_dim = Robotname::jointsCount;
    ...
    public:
        ...
        void compute_fd(Eigen::VectorXd& qdd_return, const Eigen::VectorXd& q, const Eigen::VectorXd& qd, Eigen::VectorXd& tau) const {
            ...
            Robotname::     tpl::MotionTransforms <Trait> xm;
            Robotname::dyn::tpl::InertiaProperties<Trait> ip;
            Robotname::dyn::tpl::ForwardDynamics  <Trait> fd(ip, xm);
...
Eigen::VectorXd robotname_step(Eigen::VectorXd& q, Eigen::VectorXd& qd, Eigen::VectorXd& tau){
