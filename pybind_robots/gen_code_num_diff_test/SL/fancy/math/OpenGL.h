...
iit::Fancy::Params_lengths _lengths;
_lengths.ee_x = iit::Fancy::SL::paramsGetter -> getValue_ee_x();
...
// Align the Z axis along the direction between the two joints, to display
//  the link correctly ('myDrawGLElement()' draws along the Z axis)
glRotated((GLdouble)(RAD2DEG*std::acos( 0.0/(std::sqrt(_lengths.ee_x*_lengths.ee_x + 0.0*0.0 + 0.0*0.0)) )), (GLdouble)-(0.0), (GLdouble)_lengths.ee_x, (GLdouble)0.0);
myDrawGLElement(::JB, std::sqrt(_lengths.ee_x*_lengths.ee_x + 0.0*0.0 + 0.0*0.0), 1);
glPopMatrix();

// move to the next joint, the same parameters as in the kinematics model file
glTranslated((GLdouble)_lengths.ee_x, (GLdouble)0.0, (GLdouble)0.0);
glRotated((GLdouble)(RAD2DEG*-1.5707963705062866), (GLdouble)1.0, (GLdouble)0.0, (GLdouble)0.0);
glRotated((GLdouble)(RAD2DEG*0.0), (GLdouble)0.0, (GLdouble)1.0, (GLdouble)0.0);
glRotated((GLdouble)(RAD2DEG*0.0), (GLdouble)0.0, (GLdouble)0.0, (GLdouble)1.0);

// move according to the joint state
glTranslated((GLdouble)0.0, (GLdouble)0.0, (GLdouble)state[::JB].th);
...
//  the link correctly ('myDrawGLElement()' draws along the Z axis)
// nothing to do
myDrawGLElement(::JC, 1.0, 1);
glPopMatrix();

// move to the next joint, the same parameters as in the kinematics model file
glTranslated((GLdouble)0.0, (GLdouble)0.0, (GLdouble)1.0);
glRotated((GLdouble)(RAD2DEG*0.0), (GLdouble)1.0, (GLdouble)0.0, (GLdouble)0.0);
glRotated((GLdouble)(RAD2DEG*0.0), (GLdouble)0.0, (GLdouble)1.0, (GLdouble)0.0);
glRotated((GLdouble)(RAD2DEG*0.0), (GLdouble)0.0, (GLdouble)0.0, (GLdouble)1.0);

// move according to the joint state
glRotated((GLdouble)RAD2DEG*state[::JC].th,(GLdouble)0.0, (GLdouble)0.0, (GLdouble)1.0);
...
// move according to the joint state
glTranslated((GLdouble)0.0, (GLdouble)0.0, (GLdouble)state[::JD].th);
...
// move according to the joint state
glRotated((GLdouble)RAD2DEG*state[::JE].th,(GLdouble)0.0, (GLdouble)0.0, (GLdouble)1.0);
