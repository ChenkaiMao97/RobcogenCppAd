...
const typename iit::Fancy::dyn::tpl::ForwardDynamics<TRAIT>::ExtForces
    iit::Fancy::dyn::tpl::ForwardDynamics<TRAIT>::zeroExtForces(Force::Zero());

template <typename TRAIT>
iit::Fancy::dyn::tpl::ForwardDynamics<TRAIT>::ForwardDynamics(iit::Fancy::dyn::tpl::InertiaProperties<TRAIT>& inertia, MTransforms& transforms) :
...
template <typename TRAIT>
void iit::Fancy::dyn::tpl::ForwardDynamics<TRAIT>::fd(
    JointState& qdd,
    const JointState& qd,
    ...
    const ExtForces& fext/* = zeroExtForces */)
{
    ...
    // ---------------------- THIRD PASS ---------------------- //
    link1_a = (motionTransforms-> fr_link1_X_fr_FancyBase).col(iit::rbd::LZ) * Scalar(iit::rbd::g);
