#ifndef IIT_ROBOT_FANCY_FORWARD_DYNAMICS_H_
#define IIT_ROBOT_FANCY_FORWARD_DYNAMICS_H_
...
public:
    ...
    typedef iit::Fancy::tpl::MotionTransforms<TRAIT> MTransforms;
...
inline void ForwardDynamics<TRAIT>::setJointStatus(const JointState& q) const {
    (motionTransforms-> fr_link1_X_fr_FancyBase)(q);
